...
namespace ConcertDB.Controllers
{
    public class TicketsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UseDate,IsUsed,EntranceGate")] Tickets tickets)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,UseDate,IsUsed,EntranceGate")] Tickets tickets)
        {
            if (id != tickets.Id)
            {
                return NotFound();
